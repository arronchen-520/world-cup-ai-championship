...
TEAM_SEARCH_DEPTH = os.getenv("TEAM_SEARCH_DEPTH", "advanced")
BETTING_SEARCH_DEPTH = os.getenv("BETTING_SEARCH_DEPTH", "advanced")
CONTEXT_SEARCH_DEPTH = os.getenv("CONTEXT_SEARCH_DEPTH", "advanced")
