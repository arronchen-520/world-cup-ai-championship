...
RESEARCH_SUMMARY_MODEL = os.getenv("RESEARCH_SUMMARY_MODEL", "deepseek/deepseek-chat")
RESEARCH_SUMMARY_MAX_TOKENS = int(os.getenv("RESEARCH_SUMMARY_MAX_TOKENS", "1100"))
